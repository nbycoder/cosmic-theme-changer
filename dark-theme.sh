...
bg_light="su-light.png" # CHANGE TO YOUR WALLAPAPER NAME 
...
sed -i -e "s/$theme_light/$theme_dark/g" "$theme_DIR" # CHANGE THEME
sed -i -e "s/$bg_light/$bg_dark/g" "$bg_DIR" # CHANGE WALLPAPER
sed -i -e "s/$icons_light/$icons_dark/g" "$icons_DIR" # CHANGE ICONS
